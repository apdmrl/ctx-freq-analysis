...
public class AnalyzeService {
    ...
    public AnalyzeResponseDto analyze(AnalyzeRequestDto requestDto) throws LanguageNotFoundException {
        ...
        Arrays.sort(statisticsOfText);
        ArrayUtils.reverse(statisticsOfText);
        LinkedHashMap<Character,Double> letterFreqs = FrequencyAnalysisUtil.prepareAlphabetStats(alphabet,FrequencyAnalysisUtil.calculateStatistics(responseDto.getStatsOfText()));
        ...
        contextsList.sort((o1, o2) -> {
            ...
            Arrays.sort(o1Array);
            ArrayUtils.reverse(o1Array);
            Arrays.sort(o2Array);
            ArrayUtils.reverse(o2Array);
